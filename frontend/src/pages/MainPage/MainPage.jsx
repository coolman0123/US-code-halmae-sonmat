    ...
    <div className='main-page'>
      ...
      <section className='title-section'>
        <div className='container'>
          ...
          <p className='intro-text'>시골 할매 품에서, 따뜻한 밥 한 끼와 진짜 쉼을 드립니다.</p>
        ...
        <div className='container'>
          <div className='content-row'>
            <div className='gray-box'>
              <p className='box-text'>바쁜 세상 속 쉼표, 고요한 <span className='highlight'>시골의 하루</span></p>
            </div>
          ...
          <div className='description-section'>
            <p className='description-title'>한 끼의 밥과 따스한 온기로 채우는 여행</p>
      ...
      <section className='landscape-section'>
        <div className='landscape-container'>
          ...
          <div className='landscape-overlay'>
            <p className='overlay-text-1'>오시는 분들과 함께 소박한 밥 한 끼, 따뜻한 이야기를 나누고 싶습니다.</p>
            <p className='overlay-text-2'>단순히 머물다 가는 숙소가 아닌, 정이 오가고 마음이 쉬어가는 곳이 되고자 합니다.</p>
            <p className='overlay-text-3'>할매의 손맛에 오셔서, 시골집의 온기와 함께 잊지 못할 추억을 만들어 보시는 건 어떨까요..!</p>
          </div>
        </div>
      </section>
        ...
        <div className='container'>
          <div className='content-row-right'>
            <div className='gray-box-small'>
              <p className='box-text'>손끝에 남는 흙냄새처럼,<br/><span className='highlight'>오래 기억될 하루</span></p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className='container'>
          <div className='cards-grid'>
            ...
            <div className='experience-card'>
              ...
              <div className='card-content'>
                <h3>따뜻한 밥상</h3>
                <p>할머니의 정성이 담긴 따뜻한 밥상에서 보내는 오순도순 소중한 시간</p>
              </div>
            </div>
      ...
      <section className='final-image-section'>
        <div className='container'>
          <div className='content-row-left'>
            <div className='gray-box-small'>
              <p className='box-text'>정이 흐르는 시골집에서 다시 만나는  <span className='highlight'>삶의 온기</span></p>
            </div>
          </div>
        </div>
